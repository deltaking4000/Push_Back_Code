...
ez::Drive chassis(
   ...
   // (24.0/17.91)*3.25,  // Wheel Diameter - old states robot
   (24.0/17.67)*3.25,  // Wheel Diameter - new states robot
...
ez::tracking_wheel vert_tracker(-20, 2.75, -0.88);  // This tracking wheel is parallel to the drive wheels
