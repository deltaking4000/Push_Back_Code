 ...
 */
 ...
 // USER CONTROL
void opcontrol() {
    // states of piston toggles
    bool middlegoalstate = true;
    bool middlegoaldescorestate = true;
    ...
    while (true) {
        ...
        if (controller.get_digital_new_press(DIGITAL_A)) {
           if (middlegoalstate == false) {
                drop_middlegoal();   
                middlegoalstate = true;         
           }
           else {
                lift_middlegoal();   
                middlegoalstate = false;     
           }
        }

        if (controller.get_digital_new_press(DIGITAL_Y)) {
           if (middlegoaldescorestate == false) {
                drop_middlegoaldescore();   
                middlegoaldescorestate = true;         
           }
           else {
                lift_middlegoaldescore();   
                middlegoaldescorestate = false;     
           }
        }
        ...
        // middlegoal.button_toggle(controller.get_digital(DIGITAL_A));
        //  middlegoaldescore.button_toggle(controller.get_digital(DIGITAL_Y));
